      ...
      <div className="contenedor-table">
        ...
        <section className="mx-6 my-4">
          <div className="flex justify-start p-2">
            ...
            >
              <option className="mr-2 text-lg text-black" value="Todos">Todos</option>
              <option className="mr-2 text-lg text-black" value="Aceptado">Aceptado</option>
              <option className="mr-2 text-lg text-black" value="Cancelado">Cancelado</option>
              <option className="mr-2 text-lg text-black" value="Rechazado">Rechazado</option>
            </select>
          </div>
