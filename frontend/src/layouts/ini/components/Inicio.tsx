      ...
      <div className="relative z-10 space-y-6 md:space-y-0 md:space-x-6">
        <div className="flex flex-col md:flex-row">
          <div className="sm:mx-auto sm:w-full sm:max-w-lg md:w-1/2 mb-6 md:mb-0 text-center items-center mt-10 ml-10">
            <label className="mt-10 text-azul text-4xl  font-bold">
              ¡Bienvenido a la plataforma de reservas de la FCyT!{" "}
            </label>
            <br />
            <label className="mt-5 text-lg text-azul font-semibold">
              {" "}
              Aprovecha la comodidad y eficiencia de gestionar tus reservas
            ...
            <h1 className="text-sm">
              Inicia sesión y descubre lo fácil que es asegurar el ambiente
              perfecto para tus actividades en la Facultad de Ciencias y
              Tecnología.
            </h1>
          </div>
